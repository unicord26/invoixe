        ...
        <div className="lx-branding-panel">
          ...
          <div className="lx-branding-content">
            ...
            <p className="lx-branding-desc">
              Join thousands of businesses who trust Leafx to manage their GST returns, sales records, purchases, inventory, and clients.
            </p>
          ...
          <div className="lx-branding-footer">
            © {new Date().getFullYear()} Leafx Technologies. All rights reserved.
          </div>
        </div>
        ...
        <div className="lx-form-panel">
          ...
          <div className="lx-card">
            ...
            <div className="lx-card-header">
              ...
              <div className="lx-branding-logo-text">
                <h2 style={{ fontSize: 16, color: "#111827" }}>Leafx</h2>
            ...
            <form onSubmit={mode === "in" ? doLogin : doRegister}>
              ...
              <p className="lx-toggle">
                {mode === "in" ? "New to Leafx?" : "Already have an account?"}
                <button
                  type="button"
                  onClick={() => {
